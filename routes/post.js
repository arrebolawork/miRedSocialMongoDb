...
router.post("/create", authentication, upload.single("image"), PostController.create); // ✅ "image"

router.post("/comentario/:postId", authentication, ComentarioController.create);

router.put("/id/:_id", authentication, upload.single("image"), PostController.update); // ✅ también en update
